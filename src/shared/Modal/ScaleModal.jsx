...
//         <motion.div
//           className="w-full h-full flex relative flex-col overflow-hidden border dark:bg-black bg-gray-300 hover:bg-gray-200 dark:hover:bg-gray-950 cursor-pointer"
...
export function ScaleModal({ imgSrc, videoSrc, className }) {
