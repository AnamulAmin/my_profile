    ...
    if (window.Physics) {
      ...
      Physics(function (world) {
        ...
        [
          ...
          [
            { x: renderer.width / 2 + 250, y: renderer.height - 10 },
            5,
            40,
            0.9,
            Math.PI / 2 / 3,
          ...
          world.on(
            ...
            function () {
              var constrs =
                  tree.constraints.getConstraints().distanceConstraints,
                c,
                threshold = 0.35,
                leaf;
          ...
          world.on("render-trees", function (ctx) {
            ...
            for (var i = 0, l = constrs.length; i < l; ++i) {
              c = constrs[i];
              treeStyles.lineWidth =
                "" + c.targetLength * c.targetLength * 0.0016;
              renderer.drawLine(
                c.bodyA.state.pos,
                c.bodyB.state.pos,
                treeStyles,
                  ...
                  if (cutoff && body.state.pos.get(1) < cutoff) {
                    body.applyForce(
                      dir.clone({
                        ...
                        y:
                          Math.sin(this.theta) * r -
                          (0.0004 - 0.00004) * body.mass,
                      }),
                      tmp
                    );
                  }
      ...
      console.log("PhysicsJS not loaded");
    }
  }, []);

  return <canvas id="physics-canvas" width="800" height="600"></canvas>;
};
